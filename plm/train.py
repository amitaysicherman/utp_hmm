...
parser.add_argument('--data_train', type=str, default="TIMIT_TRAIN_PH")
parser.add_argument('--data_val', type=str, default="TIMIT_TRAIN_VAL_PH")
parser.add_argument('--data_test', type=str, default="TIMIT_TEST_PH")
